...
import got from 'got';
import { YoutubeSearchSchema } from '../types/index.js';
export default async function youtubeSearch(query) {
    ...
    for (const value of contents) {
        ...
        if (isVideo) {
            ...
            const description = (_j = result.detailedMetadataSnippets.find((obj) => 'snippetText' in obj && obj.snippetText && typeof obj.snippetText === 'object' && 'runs' in obj.snippetText && Array.isArray(obj.snippetText.runs))) === null || _j === void 0 ? void 0 : _j.snippetText.runs.filter((run) => 'text' in run && typeof run.text === 'string').map((run) => run.text).join('');
            const viewH = ((_k = result.viewCountText) === null || _k === void 0 ? void 0 : _k.simpleText)
                || ((_l = result.shortViewCountText) === null || _l === void 0 ? void 0 : _l.simpleText)
                || ((_o = (_m = result.shortViewCountText) === null || _m === void 0 ? void 0 : _m.accessibility) === null || _o === void 0 ? void 0 : _o.accessibilityData.label);
            ...
            const durationH = ((_q = (_p = result.lengthText) === null || _p === void 0 ? void 0 : _p.accessibility) === null || _q === void 0 ? void 0 : _q.accessibilityData.label)
                || ((_t = (_s = (_r = result.thumbnailOverlays) === null || _r === void 0 ? void 0 : _r.find((v) => Object.keys(v)[0] === 'thumbnailOverlayTimeStatusRenderer')) === null || _s === void 0 ? void 0 : _s.thumbnailOverlayTimeStatusRenderer.text.accessibility) === null || _t === void 0 ? void 0 : _t.accessibilityData.label);
            const duration = ((_u = result.lengthText) === null || _u === void 0 ? void 0 : _u.simpleText) || ((_w = (_v = result.thumbnailOverlays) === null || _v === void 0 ? void 0 : _v.find((v) => Object.keys(v)[0] === 'thumbnailOverlayTimeStatusRenderer')) === null || _w === void 0 ? void 0 : _w.thumbnailOverlayTimeStatusRenderer.text.simpleText);
        ...
        if (isChannel) {
            ...
            // idk?
            const subscriberH = (((_x = result.videoCountText.accessibility) === null || _x === void 0 ? void 0 : _x.accessibilityData.label)
                || result.videoCountText.simpleText).trim();
            const channelName = result.title.simpleText
                || ((_y = result.shortBylineText.runs.find((run) => 'text' in run && typeof run.text === 'string')) === null || _y === void 0 ? void 0 : _y.text);
            ...
            const subscriber = subscriberH.split(' ')
                ...
                .join(' ');
            const isVerified = ((_z = result.ownerBadges.find((badge) => 'metadataBadgeRenderer' in badge && badge.metadataBadgeRenderer && typeof badge.metadataBadgeRenderer === 'object')) === null || _z === void 0 ? void 0 : _z.metadataBadgeRenderer.style) === 'BADGE_STYLE_TYPE_VERIFIED'
                || false;
